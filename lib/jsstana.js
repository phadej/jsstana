...
*/
function returnMatcher(rands) {
  assert(rands.length <= 1, "return -- takes at most one argument");
  while (rands.length < 1) {
    rands.push("?");
  }

  var valueMatcher = matcher(rands[0]);
