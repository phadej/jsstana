...
function matcher(sexpr) {
  ...
  var that = this instanceof Context ? this : new Context();
  ...
  if (_.has(builtInMatchers, rator)) {
...
Context.prototype.combineMatches = combineMatches;
Context.prototype.assertArguments = assertArguments;
Context.prototype.matcher = matcher;
Context.prototype.match = match;
